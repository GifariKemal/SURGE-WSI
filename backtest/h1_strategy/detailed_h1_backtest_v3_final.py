...
*COMPARISON*
v2: 106 trades, 48% WR, +$2,018, PF 1.22
FINAL: {stats.total_trades} trades, {stats.win_rate:.0f}% WR, ${stats.total_pnl:+,.0f}, PF {stats.profit_factor:.2f}
